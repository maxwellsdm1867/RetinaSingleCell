...
tree = riekesuite.analysis.buildTree(list, { 'protocolID','cell.label' ,'protocolSettings(imageName)','protocolSettings(imagePatchIndex)','protocolSettings(background:FilterWheel:NDF)'});
...
for num_pat = 1:node{1}.children.length %number of image patch
    ...
    legend('1000','100','10')
    hold off
    cd('/Users/Arthur/Documents/RiekeLab/210923')
    saveas(gcf,['im2patch' num2str(num_pat) '.jpg'])
end
